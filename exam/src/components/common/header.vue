          ...
          <transition name="fade">
            <div class="out" ref="out" v-show="login_flag">
              <ul>
                ...
                <li>
                  <a href="javascript:;" @click="pushSetting()">Settings</a>
                </li>
  ...
  methods: {
    ...
    pushSetting() {
      ...
      if (this.user.userRole == 1) {
        this.$router.push({ path: `/setting/${this.user.userId}` });
      } else if (this.user.userRole == 0) {
        this.$router.push({ path: `/setting_admin/${this.user.userId}` });
      }
    },
  },
};
