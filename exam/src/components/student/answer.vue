  ...
  <div id="answer">
    ...
    <div class="top">
      <ul class="item">
        <li>
          <i
            class="iconfont iconxiangmuguanli icon20"
            ref="toggle"
        ...
        <li @click="flag = !flag">
          <i class="iconfont iconzhanghao icon20"></i>
          <div class="msg" v-if="flag" @click="flag = !flag">
            <p>name：{{ userInfo.name }}</p>
            <p>userId: {{ userInfo.id }}</p>
          </div>
        </li>
        <li><i class="iconfont iconarrow-down-filling icon20"></i></li>
      </ul>
    </div>
    <div class="flexarea">
      <!--左边题目编号区-->
      <transition name="slider-fade">
        <div class="left" v-if="slider_flag">
          ...
          <div class="l-bottom">
            ...
            <div class="final" @click="commit()">end</div>
          </div>
        </div>
      </transition>
      <!--右边选择答题区-->
      <transition name="slider-fade">
        <div class="right">
          <div class="title">
            <p>{{ title }}</p>
            <i class="iconfont iconarrow-right-filling auto-right"></i>
            <span
              >全卷共{{ topicCount[0] + topicCount[1] + topicCount[2] }}题
              <i class="iconfont iconjiluchoucha"></i>倒计时：<b>{{ time }}</b
              >分钟</span
            >
          </div>
          <div class="content">
          ...
          <div class="operation">
            <ul class="end">
              <li @click="previous()">
                <i class="iconfont iconarrow-left-bold"></i><span>上一题</span>
              </li>
              <li @click="mark()">
                <i class="iconfont iconzengjia"></i><span>标记</span>
              </li>
              <li @click="next()">
                <span>下一题</span><i class="iconfont iconarrow-right-bold"></i>
              </li>
            </ul>
          </div>
        </div>
